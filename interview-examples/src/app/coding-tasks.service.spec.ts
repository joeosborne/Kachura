...
describe('Fizzbuzz', () => {
  ...
  it('returns correct output for numbers from 1 to 15', () => {
    const expected = ['1', '2', "Fizz", '4',"Buzz", "Fizz", '7','8', "Fizz", "Buzz", '11', "Fizz", '13','14', "FizzBuzz"];
    expect(service.fizzBuzz(15)).toEqual(expected);
  });

  it('returns correct output for numbers from 1 to 5', () => {
    const expected = ['1', '2', "Fizz", '4',"Buzz"];
    expect(service.fizzBuzz(5)).toEqual(expected);
  });

  it('returns correct output for numbers from 1 to 3', () => {
    const expected = ['1', '2', "Fizz"];
    expect(service.fizzBuzz(3)).toEqual(expected);
  });

  it('returns an empty array for 0', () => {
    expect(service.fizzBuzz(0)).toEqual([]);
  });


  it('returns correct output for large numbers like 30', () => {
    const expected = [
      '1', '2', "Fizz", '4',"Buzz", "Fizz", '7','8', "Fizz", "Buzz",
      '11', "Fizz", '13','14', "FizzBuzz", '16','17', "Fizz", '19', "Buzz",
      "Fizz", '22', '23', "Fizz", "Buzz", '26', "Fizz", '28', '29', "FizzBuzz"
    ];
    expect(service.fizzBuzz(30)).toEqual(expected);
  });
